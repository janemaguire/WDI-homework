...
class BirdsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bird" do
    assert_difference('Bird.count') do
      post birds_url, params: { bird: { age: @bird.age, breed: @bird.breed, image: @bird.image, name: @bird.name, toys: @bird.toys } }
    end
  ...
  test "should update bird" do
    patch bird_url(@bird), params: { bird: { age: @bird.age, breed: @bird.breed, image: @bird.image, name: @bird.name, toys: @bird.toys } }
